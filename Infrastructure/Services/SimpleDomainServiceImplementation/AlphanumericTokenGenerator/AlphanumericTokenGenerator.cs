...
namespace SimpleDomainServiceImplementation.AlphanumericTokenGenerator
{
    public class AlphanumericTokenGeneratorImplementation : IAlphanumericTokenGenerator
    {
